...
import { faGitAlt, faAngular, faWordpress } from '@fortawesome/free-brands-svg-icons';
...
/**Portfolio-erick - version 41.11 - OuterCircleIcons -
* Features:
...
const react_GradientData = [
  ...
  // ----------------------------------------------------
  // data[1]: ORBITS PATH (ADD fill-rule HERE)
  // ----------------------------------------------------
  {
    fill: 'url(#reactGradient)', 
    // ADD THIS LINE:
    fillRule: 'evenodd', // <--- This is the key!
  ...
  {
    fill: '#000000',
    d: 'M256 301.8a45.8 45.8 0 1 0 0-91.6 45.8 45.8 0 1 0 0 91.6z',
  }
];
